            ...
            >
                <div className="wrap-input100 validate-input" data-validate="Enter username">
                    ...
                    <span className="focus-input100" >
                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="m-t-45 m-l-40 bi bi-person-fill" viewBox="0 0 16 16">
                ...
                <div className="wrap-input100 validate-input" data-validate="Enter password">
                    ...
                    />
                    <span className="focus-input100">
                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="120" fill="currentColor" class="m-l-35 bi bi-keyboard" viewBox="0 0 16 16">
